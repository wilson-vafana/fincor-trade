...
<head>
	...
	<title>Manage Users - PIP Trading Admin Dashboard</title>
					...
					<div class="page-inner py-5">
						<div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
							<div>
								...
								<h5 class="text-white op-7 mb-2">Darro eWallet Admin Dashboard</h5>
							</div>
...
foreach ($users as $user) {?>
	<div class="table-responsive">
										<table id="add-row" class="display table table-striped table-hover" >
											...
											<tbody>
												<tr>
													...
													<td><?php echo $user->phone, PHP_EOL?></td>
													<td>
														<div class="form-button-action">
															<a href="mailto:<?php echo $user->email?>?subject=Hello there <?php echo $user->username?> its Milton a Developer at PIP Trading" type="button"   title="Email User Now" class="btn btn-link btn-success">
										...
										<?php } } catch (PDOException $e) {echo $e->getMessage(), PHP_EOL;}?>

...
<head>
	...
	<title>Fincor Admin - Dashboard</title>
					...
					<div class="page-inner py-5">
						<div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
							<div>
								...
								<h5 class="text-white op-7 mb-2">Fincor Admin Dashboard</h5>
							</div>
							<div class="ml-md-auto py-2 py-md-0">
								<a href="manageUsers.php" class="btn btn-white btn-border btn-round mr-2">Manage Users</a>
								<a href="addUser.php" class="btn btn-secondary btn-round">Add Users</a>
							</div>
						</div>
					</div>
				</div>
							...
							<div class="card card-stats card-round">
								<div class="card-body ">
									<div class="row">
										...
										<div class="col-7 col-stats" title="They are <?php echo $total_users;?> users.">
											<div class="numbers">
							...
							<div class="card card-stats card-round">
								<div class="card-body ">
									<div class="row">
										...
										<div class="col-7 col-stats"  title="They are investments.">
											<div class="numbers">
							...
							<div class="card card-stats card-round">
								<div class="card-body">
									<div class="row">
										...
										<div class="col-7 col-stats"  title="They are  currencies.">
											<div class="numbers">
												<p class="card-category">All Currencies</p>
												<h4 class="card-title"></h4>
											</div>
										</div>
									</div>
							...
							<div class="card card-stats card-round">
								<div class="card-body">
									<div class="row">
										<div class="col-5">
											<div class="icon-big text-center">
												<i class="flaticon-analytics text-primary"></i>
											</div>
										</div>
										<div class="col-7 col-stats">
											<div class="numbers">
												<p class="card-category">System Status</p>
												<h4 class="card-title"><?php echo $status ?></h4>
											</div>
										</div>
									</div>
								</div>
												...
												<table class="table">
													<tbody>
														<tr>
															<td>
																<div class="flag">
																	<img src="assets/img/flags/zw.png" alt="indonesia">
																</div>
															</td>
															<td>Indonesia</td>
															<td class="text-right">
